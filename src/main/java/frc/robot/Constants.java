...
public final class Constants {
    ...
    public static final int TRIGGER_BACK_ROLLER = 1;
    public static final int TRIGGER_FRONT_ROLLER = 2;
    ...
    public static final int TRIGGER_TOP_SENSOR = 0;
    public static final int TRIGGER_BOTTON_SENSOR = 1;
